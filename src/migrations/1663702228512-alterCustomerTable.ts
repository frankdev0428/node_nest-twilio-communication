...
export class alterCustomerTable1663702228512 implements MigrationInterface {
    name = 'alterCustomerTable1663702228512'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`name\``);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`firstName\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`lastName\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`name\` varchar(255) NULL DEFAULT 'NULL'`);
    }
