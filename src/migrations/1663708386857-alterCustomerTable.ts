...
export class alterCustomerTable1663708386857 implements MigrationInterface {
    name = 'alterCustomerTable1663708386857'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`address\``);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`street\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`city\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`zipCode\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD CONSTRAINT \`FK_2a0b6d85f12841b08f34ad93d07\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`zipCode\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`city\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`street\``);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`address\` varchar(255) NULL DEFAULT 'NULL'`);
    }
