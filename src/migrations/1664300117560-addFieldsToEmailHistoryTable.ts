...
export class addFieldsToEmailHistoryTable1664300117560 implements MigrationInterface {
    name = 'addFieldsToEmailHistoryTable1664300117560'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`email_history\` DROP COLUMN \`email\``);
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD \`type\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD \`fromEmail\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD \`toEmail\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD CONSTRAINT \`FK_2a0b6d85f12841b08f34ad93d07\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`email_history\` DROP COLUMN \`toEmail\``);
        await queryRunner.query(`ALTER TABLE \`email_history\` DROP COLUMN \`fromEmail\``);
        await queryRunner.query(`ALTER TABLE \`email_history\` DROP COLUMN \`type\``);
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD \`email\` varchar(255) NOT NULL`);
    }
