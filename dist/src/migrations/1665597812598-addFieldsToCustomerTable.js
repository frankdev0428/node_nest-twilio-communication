...
exports.addFieldsToCustomerTable1665597812598 = void 0;
class addFieldsToCustomerTable1665597812598 {
    constructor() {
        this.name = 'addFieldsToCustomerTable1665597812598';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`state\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`avatar\` varchar(255) NULL`);
...
exports.addFieldsToCustomerTable1665597812598 = addFieldsToCustomerTable1665597812598;
//# sourceMappingURL=1665597812598-addFieldsToCustomerTable.js.map