...
exports.addChatHistoryTable1666809212066 = void 0;
class addChatHistoryTable1666809212066 {
    constructor() {
        this.name = 'addChatHistoryTable1666809212066';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`chat_history\` (\`id\` int NOT NULL AUTO_INCREMENT, \`body\` varchar(255) NULL, \`bRead\` tinyint NOT NULL DEFAULT 0, \`createdDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`fromUserId\` int NULL, \`toUserId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.addChatHistoryTable1666809212066 = addChatHistoryTable1666809212066;
//# sourceMappingURL=1666809212066-addChatHistoryTable.js.map