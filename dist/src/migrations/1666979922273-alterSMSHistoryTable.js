...
exports.alterSMSHistoryTable1666979922273 = void 0;
class alterSMSHistoryTable1666979922273 {
    constructor() {
        this.name = 'alterSMSHistoryTable1666979922273';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`contentType\` \`contentType\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`url\` \`url\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`messageId\` \`messageId\` int NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`sms_history\` ADD CONSTRAINT \`FK_33cc0bcc588c921d6c3b1e77beb\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`messageId\` \`messageId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`url\` \`url\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message_media\` CHANGE \`contentType\` \`contentType\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`message_media\` ADD CONSTRAINT \`FK_cf9a2ed4f7555ed0f5415631aef\` FOREIGN KEY (\`messageId\`) REFERENCES \`sms_history\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
exports.alterSMSHistoryTable1666979922273 = alterSMSHistoryTable1666979922273;
//# sourceMappingURL=1666979922273-alterSMSHistoryTable.js.map