...
exports.alterVoiceHistoryTable1664925225316 = void 0;
class alterVoiceHistoryTable1664925225316 {
    constructor() {
        this.name = 'alterVoiceHistoryTable1664925225316';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`timestamp\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`callbackSource\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`sequenceNumber\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`duration\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`callDuration\` varchar(255) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD CONSTRAINT \`FK_2a0b6d85f12841b08f34ad93d07\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`callDuration\``);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`duration\``);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`sequenceNumber\``);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`callbackSource\``);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`timestamp\``);
    }
}
exports.alterVoiceHistoryTable1664925225316 = alterVoiceHistoryTable1664925225316;
//# sourceMappingURL=1664925225316-alterVoiceHistoryTable.js.map