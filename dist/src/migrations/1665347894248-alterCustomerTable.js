...
exports.alterCustomerTable1665347894248 = void 0;
class alterCustomerTable1665347894248 {
    constructor() {
        this.name = 'alterCustomerTable1665347894248';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`status\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`department\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`priority\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`agent\` varchar(255) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD CONSTRAINT \`FK_2a0b6d85f12841b08f34ad93d07\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`agent\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`priority\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`department\``);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`status\``);
    }
}
exports.alterCustomerTable1665347894248 = alterCustomerTable1665347894248;
//# sourceMappingURL=1665347894248-alterCustomerTable.js.map