...
exports.addFacebookFieldToTables1666647924520 = void 0;
class addFacebookFieldToTables1666647924520 {
    constructor() {
        this.name = 'addFacebookFieldToTables1666647924520';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`facebook_history\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`body\` varchar(255) NULL, \`numSegments\` varchar(255) NULL, \`from\` varchar(255) NULL, \`to\` varchar(255) NULL, \`accountSid\` varchar(255) NULL, \`numMedia\` varchar(255) NULL, \`apiVersion\` varchar(255) NULL, \`smsMessageSid\` varchar(255) NULL, \`smsSid\` varchar(255) NULL, \`smsStatus\` varchar(255) NULL, \`referralNumMedia\` varchar(255) NULL, \`messageSid\` varchar(255) NULL, \`createdDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedDate\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`customerId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`facebookMessageSid\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`facebookMessageSid\` varchar(255) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`question\` ADD CONSTRAINT \`FK_b8dd754e373b56714ddfa8f545c\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`customer\` DROP COLUMN \`facebookMessageSid\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`facebookMessageSid\``);
        await queryRunner.query(`DROP TABLE \`facebook_history\``);
    }
}
exports.addFacebookFieldToTables1666647924520 = addFacebookFieldToTables1666647924520;
//# sourceMappingURL=1666647924520-addFacebookFieldToTables.js.map