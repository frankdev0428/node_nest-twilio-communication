...
exports.alterVoiceHistoryTable1665086839441 = void 0;
class alterVoiceHistoryTable1665086839441 {
    constructor() {
        this.name = 'alterVoiceHistoryTable1665086839441';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE \`voice_history\` ADD \`childSids\` varchar(255) NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`email_history\` ADD CONSTRAINT \`FK_2a0b6d85f12841b08f34ad93d07\` FOREIGN KEY (\`customerId\`) REFERENCES \`customer\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`voice_history\` DROP COLUMN \`childSids\``);
    }
}
exports.alterVoiceHistoryTable1665086839441 = alterVoiceHistoryTable1665086839441;
//# sourceMappingURL=1665086839441-alterVoiceHistoryTable.js.map