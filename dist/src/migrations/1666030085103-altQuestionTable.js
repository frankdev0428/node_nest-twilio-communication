...
exports.altQuestionTable1666030085103 = void 0;
class altQuestionTable1666030085103 {
    constructor() {
        this.name = 'altQuestionTable1666030085103';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`question\` ADD \`question\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`question\` DROP COLUMN \`answer\``);
        await queryRunner.query(`ALTER TABLE \`question\` ADD \`answer\` text NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`question\` DROP COLUMN \`answer\``);
        await queryRunner.query(`ALTER TABLE \`question\` ADD \`answer\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`question\` DROP COLUMN \`question\``);
        await queryRunner.query(`ALTER TABLE \`question\` ADD \`question\` varchar(255) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`question\` ADD CONSTRAINT \`FK_b8dd754e373b56714ddfa8f545c\` FOREIGN KEY (\`categoryId\`) REFERENCES \`category\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
exports.altQuestionTable1666030085103 = altQuestionTable1666030085103;
//# sourceMappingURL=1666030085103-altQuestionTable.js.map